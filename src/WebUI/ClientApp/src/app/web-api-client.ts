...
export interface ITagsClient {
    getTags(): Observable<TagsVm>;
    create(command: CreateTagCommand): Observable<number>;
    getTodoItemsByTag(tagId: number, pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfTodoItemBriefDto>;
    delete(id: number): Observable<FileResponse>;
    addTagToTodoItem(todoItemId: number, tagId: number): Observable<FileResponse>;
...
export class TagsClient implements ITagsClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<TagsVm>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TagsVm>;
        }));
    }

    protected processGetTags(response: HttpResponseBase): Observable<TagsVm> {
        ...
        if (status === 200) {
            ...
            result200 = TagsVm.fromJS(resultData200);
    ...
    getTodoItemsByTag(tagId: number, pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfTodoItemBriefDto> {
        let url_ = this.baseUrl + "/api/Tags/{tagId}/todoitems?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTodoItemsByTag(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTodoItemsByTag(response_ as any);
                } catch (e) {
    ...
    protected processGetTodoItemsByTag(response: HttpResponseBase): Observable<PaginatedListOfTodoItemBriefDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    addTagToTodoItem(todoItemId: number, tagId: number): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Tags/todoitem/{todoItemId}/tag/{tagId}";
    ...
    protected processAddTagToTodoItem(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class TagsVm implements ITagsVm {
    tags?: TagDto[];

    constructor(data?: ITagsVm) {
        if (data) {
    ...
    static fromJS(data: any): TagsVm {
        data = typeof data === 'object' ? data : {};
        let result = new TagsVm();
        result.init(data);
        return result;
    }
